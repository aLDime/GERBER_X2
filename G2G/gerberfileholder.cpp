...
//QMap<QString, QPair<GerberFile*, GerberItemGroup*> > GerberFileHolder::files;
...
//            int c = 0, cc;
//            QMapIterator<QString, QPair<GerberFile*, GerberItemGroup*> > i(files);
//            while (i.hasNext()) {
//                i.next();
...
//void GerberFileHolder::handleFile(GerberFile* gerberFile)
//{
...
//GerberFile* GerberFileHolder::getFile(const QString& fileName)
//{
